from sqlalchemy import Column, String, Integer, DateTime, Float, Text, JSON, ForeignKey, Enum
...
class Bill(Base):
    ...
    analysis = relationship("Analysis", back_populates="bill", uselist=False, cascade="all, delete-orphan")
